  ...
  for (let i = 0; i < closeBtn.length; i++) {
    closeBtn[i].onclick = function () {
      ...
      if (hWrapper.style.display == "block") {
        ...
        setTimeout(function () {
          hCard.style.setProperty("width", "calc(" + document.querySelector("#navbar").offsetWidth + "px - 102px)", "important");
          hCard.style.height = "auto";
          hCard.style.margin = "15px 20px";
          hCard.style.position = "static";
        ...
        setTimeout(function () {
          if (hCard.style.width = "calc(" + document.querySelector("#navbar").offsetWidth + "px - 102px)") {
            document.querySelector("#hyderite-card").addEventListener("click", function () {
              var card = document.querySelector("#hyderite-card");
              card.style.transform = "rotate(0) scale(0.85)";
              document.querySelector("#h-wrapper").style.opacity = "0";
        ...
        setTimeout(function () {
          jCard.style.setProperty("width", "calc(" + document.querySelector("#navbar").offsetWidth + "px - 102px)", "important");
          jCard.style.height = "auto";
          jCard.style.margin = "15px 20px";
          jCard.style.position = "static";
          jCard.style.transform = "rotate(0deg) translate(0)";
          document.querySelector("#black-filter").style.opacity = "0";
        }, 300);
        setTimeout(function () {
          document.querySelector("#black-filter").style.zIndex = "-1";
          ...
          jCard.onmouseover = function () {
            jCard.style.transform = "translateY(-25px)";
          };
          jCard.onmouseout = function () {
            jCard.style.transform = "translateY(0)";
          };
          jCard.style.zIndex = "0";
        }, 600);
        setTimeout(function () {
          if (jCard.style.width = "calc(" + document.querySelector("#navbar").offsetWidth + "px - 102px") {
            document.querySelector("#jip-card").addEventListener("click", function () {
              var card = document.querySelector("#jip-card");
              card.style.transform = "rotate(0) scale(0.85)";
              document.querySelector("#j-wrapper").style.opacity = "0";
        ...
        setTimeout(function () {
          tCard.style.width = "calc(" + document.querySelector("#navbar").offsetWidth + "px - 102px)";
          tCard.style.height = "auto";
          tCard.style.margin = "15px 20px";
          tCard.style.position = "static";
          document.querySelector("#black-filter").style.opacity = "0";
        }, 300);
        setTimeout(function () {
          document.querySelector("#black-filter").style.zIndex = "-1";
          ...
          tCard.onmouseover = function () {
            tCard.style.transform = "translateY(-25px)";
          };
        ...
        setTimeout(function () {
          if (tCard.style.width = "calc(" + document.querySelector("#navbar").offsetWidth + "px - 102px") {
            document.querySelector("#tca-card").addEventListener("click", function () {
              var card = document.querySelector("#tca-card");
              card.style.transform = "rotate(0) scale(0.85)";
              document.querySelector("#t-wrapper").style.opacity = "0";
